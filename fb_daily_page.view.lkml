view: daily_fb_page {
  ...
  dimension: clicks {
    type: number
    sql: ${page_call_phone_clicks_by_site_logged_in_unique_api}
          + ${page_call_phone_clicks_by_site_logged_in_unique_mobile}
          + ${page_call_phone_clicks_by_site_logged_in_unique_other}
          + ${page_call_phone_clicks_by_site_logged_in_unique_www}
          + ${page_call_phone_clicks_logged_in_unique}
          + ${page_consumptions_by_consumption_type_button_clicks}
          + ${page_consumptions_by_consumption_type_link_clicks}
          + ${page_consumptions_by_consumption_type_other_clicks}
          + ${page_consumptions_by_consumption_type_unique_button_clicks}
          + ${page_consumptions_by_consumption_type_unique_link_clicks}
          + ${page_consumptions_by_consumption_type_unique_other_clicks}
          + ${page_cta_clicks_by_site_logged_in_unique_1253062944710761_api}
          + ${page_cta_clicks_by_site_logged_in_unique_1253062944710761_mobile}
          + ${page_cta_clicks_by_site_logged_in_unique_1253062944710761_other}
          + ${page_cta_clicks_by_site_logged_in_unique_1253062944710761_www}
          + ${page_cta_clicks_by_site_logged_in_unique_1813384115345305_api}
          + ${page_cta_clicks_by_site_logged_in_unique_1813384115345305_mobile}
          + ${page_cta_clicks_by_site_logged_in_unique_1813384115345305_other}
          + ${page_cta_clicks_by_site_logged_in_unique_1813384115345305_www}
          + ${page_cta_clicks_logged_in_total_1253062944710761}
          + ${page_cta_clicks_logged_in_total_1813384115345305}
          + ${page_cta_clicks_logged_in_unique_1253062944710761}
          + ${page_cta_clicks_logged_in_unique_1813384115345305}
          + ${page_get_directions_clicks_by_site_logged_in_unique_api}
          + ${page_get_directions_clicks_by_site_logged_in_unique_mobile}
          + ${page_get_directions_clicks_by_site_logged_in_unique_other}
          + ${page_get_directions_clicks_by_site_logged_in_unique_www}
          + ${page_get_directions_clicks_logged_in_unique}
          + ${page_website_clicks_by_site_logged_in_unique_api}
          + ${page_website_clicks_by_site_logged_in_unique_mobile}
          + ${page_website_clicks_by_site_logged_in_unique_other}
          + ${page_website_clicks_by_site_logged_in_unique_www}
...
# ------ Measures ------
  ...
  measure: total_engagements_clicks {
    label: "Total Engagements + Clicks"
    type: number
    sql: ${total_clicks} + ${total_engagements} ;;
    drill_fields: [detail*]
  }
...
## flag for "A" measures to only include appropriate time range
  ...
  measure: page_video_view_mins_a {
    view_label: "Pd-Over-Pd Metrics"
    type: sum
    sql: round((${page_video_view_time} / 60000), 0) ;;
    drill_fields: [detail*]
    filters: {
      field: group_a
      value: "yes"
...
## filter on comparison queries to avoid querying unnecessarily large date ranges.
  ...
  set: detail {
    fields: [metric_date, total_views, total_organic_views, total_paid_views, total_impressions, total_engagements,
