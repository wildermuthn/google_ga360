...
#       ga_sessions.visitStart_date: 2018/02/12 to 2018/02/18
  ...
  - title: Video Output
    ...
    type: single_value
    fields:
    - daily_fb_page.total_video_output_a
    - daily_fb_page.total_video_output_b
    filters:
      daily_fb_page.is_in_date_a_or_b: 'Yes'
    limit: 500
    column_limit: 50
    ...
    - table_calculation: percent_change
      label: Percent Change
      expression: "(${daily_fb_page.total_video_output_a} - ${daily_fb_page.total_video_output_b})/${daily_fb_page.total_video_output_b}"
      value_format:
      value_format_name: percent_0
      _kind_hint: measure
      _type_hint: number
  ...
  - title: Video Views Per Post
    ...
    type: single_value
    fields:
    - daily_fb_page.average_views_per_video_post_a
    - daily_fb_page.average_views_per_video_post_b
    filters:
      daily_fb_page.is_in_date_a_or_b: 'Yes'
    limit: 500
    column_limit: 50
    ...
    - table_calculation: percent_change
      label: Percent Change
      expression: "(${daily_fb_page.average_views_per_video_post_a} - ${daily_fb_page.average_views_per_video_post_b})/${daily_fb_page.average_views_per_video_post_b}"
      value_format:
      value_format_name: percent_0
      _kind_hint: measure
      _type_hint: number
    ...
    totals_color: "#808080"
    series_types: {}
    comparison_label: Video Views/Post LW
    listen:
      Date Filter: daily_fb_page.date_a
      Comparison Date Filter: daily_fb_page.date_b
    row: 0
